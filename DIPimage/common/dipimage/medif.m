...
%
% SYNOPSIS:
%  image_out = medif(image_in,filterSize,filterShape)
%
% PARAMETERS:
...
function image_out = medif(varargin)
...
d = struct('menu','Filters',...
           ...
           'inparams',struct('name',       {'image_in',   'filterSize',    'filterShape'},...
                             ...
                             'dim_check',  {[],           1,               0},...
                             'range_check',{{'scalar','real'},'R+',        {'rectangular','elliptic','diamond'}},...
                             'required',   {1,            0,               0},...
...
image_out = dip_medianfilter(image_in,[],filterSize,filterShape);
