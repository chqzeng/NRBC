...
%
% SYNOPSIS:
%  image_out = radialmax(image_in,[mask],binSize,innerRadius)
%
% PARAMETERS:
...
function image_out = radialmax(varargin)
...
image_out = dip_radialmaximum(image_in,mask,[],binSize,innerRadius,[]);
