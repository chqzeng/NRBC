...
%
% SYNOPSIS:
%  image_out = radialmean(image_in,[mask],binSize,innerRadius)
%
% PARAMETERS:
...
% 27 October 2005:   Added MASK parameter. (BR)
% 18 August 2009:    Made MASK parameter optional, to match RADIAL* functions. (CL)

function image_out = radialmean(varargin)
...
image_out = dip_radialmean(image_in,mask,[],binSize,innerRadius,[]);
