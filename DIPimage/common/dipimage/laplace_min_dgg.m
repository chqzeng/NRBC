...
%
% SYNOPSIS:
%  image_out = laplace_min_dgg(image_in,sigma)
%
% DEFAULTS:
%  sigma = 1
...
function image_out = laplace_min_dgg(varargin)

d = struct('menu','Differential Filters',...
           'display','Laplace - Dgg (== Dcc in 2D)',...
...
image_out = dip_laplacemindgg(image_in,process,sigma,method);
