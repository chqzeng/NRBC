...
%
% SYNOPSIS:
%  image_out = dilation_se(image_in,se)
%
% PARAMETERS:
...
function image_out = dilation_se(varargin)

d = struct('menu','Morphology',...
  'display','Custom dilation',...
...
image_out = dip_dilation(image_in,se,ones(ndims(image_in),1),'user_defined');
