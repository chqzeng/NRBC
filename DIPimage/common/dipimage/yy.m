...
%
%   YY(...,'freq') uses frequency domain coordinates, range=(-0.5,0.5)
%      (not in combination with ORIGIN).
%   YY(...,'radfreq') uses frequency domain coordinates, range=(-pi,pi)
%      (not in combination with ORIGIN).
%
%   YY(...,'math')  Let the Y coordinate increase upwards instead of
%      downwards.
%   YY(...,'mleft') Combines 'left' with 'math'. Also available are:
