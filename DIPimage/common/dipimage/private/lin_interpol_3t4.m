function [out1, out2, out3, out4] = lin_interpol_3t4(in1, in2, in3, matrix_in)
...
out4 = zeros( size_in(1), size_in(2));
...
p000 = vals(offset(:, 1), 4);
p001 = vals(offset(:, 2), 4);
p010 = vals(offset(:, 3), 4);
p011 = vals(offset(:, 4), 4);
p100 = vals(offset(:, 5), 4);
p101 = vals(offset(:, 6), 4);
p110 = vals(offset(:, 7), 4);
p111 = vals(offset(:, 8), 4);
