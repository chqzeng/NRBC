...
%
%  Returns  err = mean(abs(in1-in2)/abs(in2))  for the pixels in <mask>.
%  <mask> can be an empty array to process all pixels.
%
% SYNOPSIS:
%  err = mre(in1,in2,mask)
%
% SEE ALSO:
%  mse, mae, lfmse, ssim, psnr, noisestd.
...
function err = mre(varargin)

d = struct('menu','Statistics',...
           'display','Mean relative error',...
