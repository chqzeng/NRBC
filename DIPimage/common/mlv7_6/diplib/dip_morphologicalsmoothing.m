...
%    out = dip_morphologicalsmoothing(in, se, filterParam, shape, flags)
%
%   in
%      Image.
%   se
...
%   flags
%      Smoothing method. String containing one of the following values:
%      'open/close', 'close/open', 'average'.
...
% 	dipf_MphSmoothing flags	 	int flags	 	flags	
%
%
