...
%    out = dip_tophat(in, se, filterParam, shape, edgeType, polarity)
%
%   in
%      Image.
%   se
...
%   edgeType
%      Edge Type. String containing one of the following values:
%      'texture', 'object', 'both'.
%   polarity
%      Polarity. String containing one of the following values:
%      'black', 'white'.
...
%  dip_MphEdgeType edgeType      MphEdgeType edgeType    edgeType
%  dip_MphTophatPolarity polarity      MphTophatPolarity polarity    polarity
%
%
