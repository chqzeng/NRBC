...
%    out = dip_radialminimum(in, mask, ps, binSize, innerRadius, center)
%
%   in
%      Image.
%   mask
...
%FUNCTION
%This function computes the radial projection of the sum of the pixel
%intensities of in.
%
%
%The radial projection is performed for the dimensions specified by ps. If the
%radial distance of a pixel to the center of the image is r, than the minimum of
